...
$app->post('/api/UberRide/getAccessToken', function ($request, $response, $args) {
    ...
    $query['client_secret'] = $post_data['args']['clientSecret'];  
    $query['client_id'] = $post_data['args']['clientId'];
    $query['grant_type'] = 'authorization_code';
    $query['code'] = $post_data['args']['code'];
    $query['redirect_uri'] = $post_data['args']['redirectUri'];

    $query_str = 'https://login.uber.com/oauth/v2/token';
